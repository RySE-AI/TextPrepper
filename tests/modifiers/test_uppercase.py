...
def results(input_strings):
    results = [text.upper() for text in input_strings]
    return results
...
def test_upper_str(input_strings, setup_processor, results):
...
def test_upper_doc(input_documents, setup_processor, doc_results):
